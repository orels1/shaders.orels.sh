...
export default function CopyButton({
  ...
  return (
    <button
      ...
      className={clsx(className, 'flex items-center justify-center bg-slate-800 w-[32px] h-[32px] p-1 ring-1 ring-white/10 hover:ring-orange-400 transition-all group/inner rounded-md')}
    >
       <svg
        aria-hidden="true"
        viewBox="0 0 20 20"
      >
        <g className="dark:block text-white/40 group-hover/inner:text-white/90 group-active/inner:text-orange-400 transition-colors">
